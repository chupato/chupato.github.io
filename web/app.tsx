                    ...
                    <tr key={p.id} class='border-b border-base-200'>
                      <td class='py-1 px-2'>
                        <span
                          role='img'
                          aria-label={p.cls}
                          class={`${styles.classButton} ${styles[p.cls.toUpperCase()]} inline-block w-6 h-6 rounded-full`}
                          style={{
              ...
              <div class='flex items-center justify-evenly p-2'>
                <div class='flex flex-col items-center gap-1'>
                  ...
                  <div class='text-center'>
                    ...
                    <div class='stat-desc text-sm'>~{mockWarsongAvgWait} wait</div>
                  </div>
                </div>
                <div class='divider divider-horizontal'></div>
                <div class='flex flex-col items-center gap-1'>
                  ...
                  <div class='text-center'>
                    ...
                    <div class='stat-desc text-sm'>~{mockArena3v3AvgWait} wait</div>
                  </div>
                </div>
              </div>
            </div>
